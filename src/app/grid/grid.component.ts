...
export class GridComponent implements OnInit, OnChanges {
  ...
  @Input("column-definition-service")
  columnDefinitionService: IColumnDefintionService;
  @Input("rowData") rowData: any;
  @Input("loadData") loadData: any;
  @Input("parent") parent: any;

  @Input("enableFilter")
  enableFilter: boolean = !this.enableFilter
    ? GridSettingsConstants.enableFilter
    : this.enableFilter;
  @Input("enableSorting")
  enableSorting: boolean = !this.enableSorting
    ? GridSettingsConstants.enableSorting
    : this.enableSorting;
  @Input("enableColResize")
  enableColResize: boolean = !this.enableColResize
    ? GridSettingsConstants.enableColResize
    : this.enableColResize;
  @Input("rowSelection")
  rowSelection: string = !this.rowSelection
    ? GridSettingsConstants.rowSelection
    : this.rowSelection;
  @Input("enablePagination")
  enablePagination: boolean = !this.enablePagination
    ? GridSettingsConstants.enablePagination
  ...
  ngOnInit() {
    this.columnDefs = this.columnDefinitionService.getColumnDefinition(
      this.columnDefinitionKey
    );
  ...
  onReady(params: any): any {
    ...
    this.gridApi.setRowData(RefData.Data);
    // this.setRowData();
  }
